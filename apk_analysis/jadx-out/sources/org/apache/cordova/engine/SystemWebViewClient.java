...
public class SystemWebViewClient extends WebViewClient {
    ...
    public SystemWebViewClient(final SystemWebViewEngine parentEngine) {
        ...
        httpAllowed.addPathHandler("/", new WebViewAssetLoader.PathHandler() { // from class: org.apache.cordova.engine.SystemWebViewClient$$ExternalSyntheticLambda0
            ...
            public final WebResourceResponse handle(String str) {
                return SystemWebViewClient.this.m2057lambda$new$0$orgapachecordovaengineSystemWebViewClient(parentEngine, str);
            }
        });
    ...
    /* synthetic */ WebResourceResponse m2057lambda$new$0$orgapachecordovaengineSystemWebViewClient(final SystemWebViewEngine parentEngine, String path) {
        ...
        try {
            ...
            InputStream open = parentEngine.webView.getContext().getAssets().open("www/" + path, 2);
