...
public class WebkitToCompatConverter {
    ...
    public ServiceWorkerWebSettings convertServiceWorkerSettings(InvocationHandler invocationHandler) {
        return ViewPager2$$ExternalSyntheticApiModelOutline0.m201m(this.mImpl.convertServiceWorkerSettings(invocationHandler));
    }
    ...
    public SafeBrowsingResponse convertSafeBrowsingResponse(InvocationHandler invocationHandler) {
        return ViewPager2$$ExternalSyntheticApiModelOutline0.m199m(this.mImpl.convertSafeBrowsingResponse(invocationHandler));
    }
