...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public boolean terminate() {
        ...
        if (q.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess m207m = ViewPager2$$ExternalSyntheticApiModelOutline0.m207m((Object) this.mFrameworkObject.get());
            return m207m != null && ApiHelperForQ.terminate(m207m);
        }
