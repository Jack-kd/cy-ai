...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            isRequestPinShortcutSupported = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).isRequestPinShortcutSupported();
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            requestPinShortcut = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent createShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            shortcuts = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getShortcuts(i);
            return ShortcutInfoCompat.fromShortcuts(context, shortcuts);
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager m12m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                manifestShortcuts = m12m.getManifestShortcuts();
                arrayList.addAll(manifestShortcuts);
            }
            if ((i & 2) != 0) {
                dynamicShortcuts = m12m.getDynamicShortcuts();
                arrayList.addAll(dynamicShortcuts);
            }
            if ((i & 4) != 0) {
                pinnedShortcuts = m12m.getPinnedShortcuts();
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            addDynamicShortcuts = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).addDynamicShortcuts(arrayList);
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        maxShortcutCountPerActivity = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getMaxShortcutCountPerActivity();
    ...
    public static boolean isRateLimitingActive(Context context) {
        ...
        isRateLimitingActive = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).isRateLimitingActive();
    ...
    public static int getIconMaxWidth(Context context) {
        ...
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            iconMaxWidth = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getIconMaxWidth();
            return iconMaxWidth;
        }
    ...
    public static int getIconMaxHeight(Context context) {
        ...
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            iconMaxHeight = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getIconMaxHeight();
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            dynamicShortcuts = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).setDynamicShortcuts(arrayList);
            if (!dynamicShortcuts) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        List dynamicShortcuts;
        if (Build.VERSION.SDK_INT >= 25) {
            dynamicShortcuts = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).getDynamicShortcuts();
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            updateShortcuts = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2())).updateShortcuts(arrayList);
            if (!updateShortcuts) {
                return false;
            }
        }
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            ShortcutManager m12m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m(context.getSystemService(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2()));
            isRateLimitingActive = m12m.isRateLimitingActive();
            if (isRateLimitingActive) {
                return false;
            }
            dynamicShortcuts = m12m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                m12m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            m12m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
