...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                breakStrategy = Profiling$$ExternalSyntheticApiModelOutline0.m105m(textPaint).setBreakStrategy(i);
    ...
    public PrecomputedText getPrecomputedText() {
        if (Profiling$$ExternalSyntheticApiModelOutline0.m$1(this.mText)) {
            return Profiling$$ExternalSyntheticApiModelOutline0.m106m((Object) this.mText);
        }
        return null;
    }
