...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f13top;
    }
    ...
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f13top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f13top, insets.right, insets.bottom);
    }
    ...
    private static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 1) {
                if (z) {
                    return Insets.of(0, Math.max(getRootStableInsets().f13top, getSystemWindowInsets().f13top), 0, 0);
                }
                return Insets.of(0, getSystemWindowInsets().f13top, 0, 0);
            }
            if (i == 2) {
                if (z) {
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f13top - i2);
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f13top, insets.right, insets.bottom);
            }
        }
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = Profiling$$ExternalSyntheticApiModelOutline0.m107m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m107m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m107m = HalfKt$$ExternalSyntheticApiModelOutline0.m145m(windowInsets);
            } else {
                m107m = Profiling$$ExternalSyntheticApiModelOutline0.m107m();
            }
            this.mPlatBuilder = m107m;
        }
