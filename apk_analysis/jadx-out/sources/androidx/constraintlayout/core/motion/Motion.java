...
public class Motion implements TypedValues {
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.f5top = this.mStartMotionPath.y;
        floatRect.right = floatRect.left + this.mStartMotionPath.width;
        floatRect.bottom = floatRect.f5top + this.mStartMotionPath.height;
        FloatRect floatRect2 = new FloatRect();
        floatRect2.left = this.mEndMotionPath.x;
        floatRect2.f5top = this.mEndMotionPath.y;
        floatRect2.right = floatRect2.left + this.mEndMotionPath.width;
        floatRect2.bottom = floatRect2.f5top + this.mEndMotionPath.height;
    ...
    public void setStartState(ViewState viewState, MotionWidget motionWidget, int i, int i2, int i3) {
        ...
        if (i == 1) {
            ...
            rect.left = ((viewState.f7top + viewState.bottom) - viewState.width()) / 2;
            rect.f6top = i2 - ((i4 + viewState.height()) / 2);
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f6top + viewState.height();
        } else if (i == 2) {
            int i5 = viewState.left + viewState.right;
            rect.left = i3 - (((viewState.f7top + viewState.bottom) + viewState.width()) / 2);
            rect.f6top = (i5 - viewState.height()) / 2;
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f6top + viewState.height();
        }
        this.mStartMotionPath.setBounds(rect.left, rect.f6top, rect.width(), rect.height());
    ...
    void rotate(Rect rect, Rect rect2, int i, int i2, int i3) {
        if (i == 1) {
            ...
            rect2.left = ((rect.f6top + rect.bottom) - rect.width()) / 2;
            rect2.f6top = i3 - ((i4 + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f6top + rect.height();
            return;
        }
        if (i == 2) {
            int i5 = rect.left + rect.right;
            rect2.left = i2 - (((rect.f6top + rect.bottom) + rect.width()) / 2);
            rect2.f6top = (i5 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f6top + rect.height();
            return;
        }
        if (i != 3) {
            ...
            rect2.left = i2 - (((rect.bottom + rect.f6top) + rect.width()) / 2);
            rect2.f6top = (i6 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f6top + rect.height();
            return;
        }
        ...
        int i8 = rect.f6top;
        int i9 = rect.bottom;
        rect2.left = ((rect.height() / 2) + rect.f6top) - (i7 / 2);
        rect2.f6top = i3 - ((i7 + rect.height()) / 2);
        rect2.right = rect2.left + rect.width();
        rect2.bottom = rect2.f6top + rect.height();
    }
