...
public class MotionWidget implements TypedValues {
    ...
    public String toString() {
        return this.widgetFrame.left + ", " + this.widgetFrame.f8top + ", " + this.widgetFrame.right + ", " + this.widgetFrame.bottom;
    }
    ...
    public int getHeight() {
        return this.widgetFrame.bottom - this.widgetFrame.f8top;
    }
