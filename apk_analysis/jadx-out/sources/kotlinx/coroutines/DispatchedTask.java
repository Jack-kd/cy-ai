    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        ...
                        continuation.resumeWith(Result.m269constructorimpl(ResultKt.createFailure(cancellationException)));
                    }
                    cancellationException = cancellationException2;
                    continuation.resumeWith(Result.m269constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m269constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m269constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    m269constructorimpl2 = Result.m269constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    m269constructorimpl2 = Result.m269constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m272exceptionOrNullimpl(m269constructorimpl2));
            } finally {
            ...
            try {
                ...
                taskContext.afterTask();
                m269constructorimpl = Result.m269constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.INSTANCE;
                m269constructorimpl = Result.m269constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m272exceptionOrNullimpl(m269constructorimpl));
        }
    }
