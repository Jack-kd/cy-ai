            ...
            if (continuation instanceof FlowKt__ChannelsKt$emitAllImpl$1) {
                ...
                if ((flowKt__ChannelsKt$emitAllImpl$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        obj = receiveChannel.mo1813receiveCatchingJP2dKIU(flowKt__ChannelsKt$emitAllImpl$1);
                        ...
                        flowCollector = z2;
                        r9 = flowCollector2;
                        if (!ChannelResult.m1828isClosedimpl(obj)) {
                        }
                    } else if (i == 2) {
                        ...
                        try {
                            ...
                            if (!ChannelResult.m1828isClosedimpl(obj)) {
                                Throwable m1824exceptionOrNullimpl = ChannelResult.m1824exceptionOrNullimpl(obj);
                            ...
                            Object m1826getOrThrowimpl = ChannelResult.m1826getOrThrowimpl(obj);
                            ...
                            Object emit = r9.emit(m1826getOrThrowimpl, flowKt__ChannelsKt$emitAllImpl$1);
                            z4 = flowCollector;
                            flowCollector4 = r9;
