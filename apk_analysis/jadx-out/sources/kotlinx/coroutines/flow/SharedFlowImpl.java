    ...
    */
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArr) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m269constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m269constructorimpl(Unit.INSTANCE));
        ...
        for (Continuation<Unit> continuation2 : continuationArr) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m269constructorimpl(Unit.INSTANCE));
            }
        }
