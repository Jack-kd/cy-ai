                ...
                */
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        mo1813receiveCatchingJP2dKIU = this.$second.mo1813receiveCatchingJP2dKIU(this);
                    ...
                    if (mo1813receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable m1824exceptionOrNullimpl = ChannelResult.m1824exceptionOrNullimpl(mo1813receiveCatchingJP2dKIU);
                        if (m1824exceptionOrNullimpl == null) {
                            throw new AbortFlowException(flowCollector3);
                        }
                        throw m1824exceptionOrNullimpl;
                    }
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (mo1813receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        mo1813receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector3;
                    this.label = 2;
                    obj = function3.invoke(t1, mo1813receiveCatchingJP2dKIU, this);
                ...
                if (continuation instanceof CombineKt$zipImpl$1$1$2$1$emit$1) {
                    ...
                    if ((combineKt$zipImpl$1$1$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c00071, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        } else {
                            if (i != 1) {
