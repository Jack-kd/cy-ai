...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            m269constructorimpl = Result.m269constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m269constructorimpl = Result.m269constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m272exceptionOrNullimpl(m269constructorimpl) != null) {
            m269constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) m269constructorimpl;
    }
