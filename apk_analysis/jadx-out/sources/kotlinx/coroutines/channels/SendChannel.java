...
public interface SendChannel<E> {
    ...
    Object mo1815trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1815trySendJP2dKIU = sendChannel.mo1815trySendJP2dKIU(e);
            if (ChannelResult.m1830isSuccessimpl(mo1815trySendJP2dKIU)) {
                return true;
            }
            Throwable m1824exceptionOrNullimpl = ChannelResult.m1824exceptionOrNullimpl(mo1815trySendJP2dKIU);
