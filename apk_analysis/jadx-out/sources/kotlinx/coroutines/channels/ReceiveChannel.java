...
public interface ReceiveChannel<E> {
    ...
    Object mo1813receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1814tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1814tryReceivePtdJZtk = receiveChannel.mo1814tryReceivePtdJZtk();
            if (ChannelResult.m1830isSuccessimpl(mo1814tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1826getOrThrowimpl(mo1814tryReceivePtdJZtk);
            }
            Throwable m1824exceptionOrNullimpl = ChannelResult.m1824exceptionOrNullimpl(mo1814tryReceivePtdJZtk);
            if (m1824exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1824exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo1813receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo1813receiveCatchingJP2dKIU = receiveChannel.mo1813receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo1813receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo1813receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    }
                    return ChannelResult.m1825getOrNullimpl(mo1813receiveCatchingJP2dKIU);
                }
            }
