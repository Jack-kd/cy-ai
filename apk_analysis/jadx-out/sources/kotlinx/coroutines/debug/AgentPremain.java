...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m269constructorimpl = Result.m269constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m269constructorimpl = Result.m269constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m275isFailureimpl(m269constructorimpl) ? null : m269constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1838installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1838installSignalHandler$lambda1(Signal signal) {
