...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m1799delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1800toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1800toDelayMillisLRDsOJo(long j) {
        if (Duration.m1634compareToLRDsOJo(j, Duration.INSTANCE.m1738getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1653getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
