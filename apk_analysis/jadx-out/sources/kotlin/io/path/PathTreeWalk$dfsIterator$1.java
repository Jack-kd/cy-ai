    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (isDirectory) {
                ...
                throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1492m(path3.toString());
            }
        ...
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    Path path5 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1499m(this.L$5);
                        ...
                        if (contentIterator.hasNext()) {
                            ...
                            if (isDirectory3) {
                                ...
                                if (!createsCycle2) {
                                    ...
                                    PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$2();
                                    throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1492m(path62.toString());
                                }
                            } else {
        ...
        path4 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1499m(this.L$5);
