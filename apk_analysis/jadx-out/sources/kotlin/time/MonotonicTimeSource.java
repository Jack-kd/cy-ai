...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1775boximpl(m1769markNowz9LOYto());
    }
    ...
    public long m1769markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1778constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1768elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1767differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1766adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1778constructorimpl(LongSaturatedMathKt.m1764saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
