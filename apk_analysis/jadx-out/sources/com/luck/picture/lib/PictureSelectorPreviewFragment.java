...
public class PictureSelectorPreviewFragment extends PictureCommonFragment {
    ...
    public void changeViewParams(int[] iArr) {
        ...
        if (itemViewParams == null || iArr[0] == 0 || iArr[1] == 0) {
            ...
            this.magicalView.setViewParams(itemViewParams.left, itemViewParams.f16top, itemViewParams.width, itemViewParams.height, iArr[0], iArr[1]);
        ...
        this.completeSelectView.setOnClickListener(new View.OnClickListener() { // from class: com.luck.picture.lib.PictureSelectorPreviewFragment.6
            ...
            */
            public void onClick(View view) {
                ...
                if (PictureSelectorPreviewFragment.this.selectorConfig.isEmptyResultReturn && PictureSelectorPreviewFragment.this.selectorConfig.getSelectCount() == 0) {
    ...
    public void setMagicalViewParams(int i, int i2, int i3) {
        ...
        if (itemViewParams == null || i == 0 || i2 == 0) {
            ...
            this.magicalView.setViewParams(itemViewParams.left, itemViewParams.f16top, itemViewParams.width, itemViewParams.height, i, i2);
        }
    }
    ...
    private void getImageRealSizeFromMedia(final LocalMedia localMedia, boolean z, final OnCallbackListener<int[]> onCallbackListener) {
        ...
        if (z2) {
            onCallbackListener.onCall(new int[]{i, i2});
        }
    }
