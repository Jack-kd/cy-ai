...
public class ForegroundService extends Service {
    ...
    private Notification createForegroundNotification() {
        ...
        if (SdkVersionUtils.isO()) {
            PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1505m();
            NotificationChannel m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(CHANNEL_ID, "com.luck.picture.lib", i);
