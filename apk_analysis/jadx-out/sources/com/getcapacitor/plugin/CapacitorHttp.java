...
@CapacitorPlugin(permissions = {@Permission(alias = "HttpWrite", strings = {PermissionConfig.WRITE_EXTERNAL_STORAGE}), @Permission(alias = "HttpRead", strings = {PermissionConfig.READ_EXTERNAL_STORAGE})})
