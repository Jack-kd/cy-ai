    ...
    */
    private void loadWebView() {
        ...
        if (WebViewFeature.isFeatureSupported(WebViewFeature.DOCUMENT_START_SCRIPT)) {
            ...
            if (Build.VERSION.SDK_INT >= 24 && this.config.isResolveServiceWorkerRequests()) {
                ...
                serviceWorkerController.setServiceWorkerClient(new ServiceWorkerClient() { // from class: com.getcapacitor.Bridge.1
    ...
    public boolean isMinimumWebViewInstalled() {
        ...
        try {
            ...
            return Integer.parseInt(InternalUtils.getPackageInfo(packageManager, str).versionName.split("\\.")[0]) >= this.config.getMinWebViewVersion();
        } catch (Exception e) {
    ...
    private void initWebView() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " yybPackageName/" + this.context.getPackageName() + " yybDevice/" + Settings.Secure.getString(getContext().getContentResolver(), "android_id"));
    }
    ...
    public void triggerJSEvent(String str, String str2, String str3) {
        eval("window.Capacitor.triggerEvent(\"" + str + "\", \"" + str2 + "\", " + str3 + ")", new ValueCallback() { // from class: com.getcapacitor.Bridge$$ExternalSyntheticLambda7
            @Override // android.webkit.ValueCallback
            public final void onReceiveValue(Object obj) {
    ...
    public void setServerAssetPath(String str) {
        ...
        this.webView.post(new Runnable() { // from class: com.getcapacitor.Bridge$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void reload() {
        this.webView.post(new Runnable() { // from class: com.getcapacitor.Bridge$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
