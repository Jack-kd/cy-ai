            ...
            if ((_filesystemkt_collectrecursively_1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (i != 1) {
                        ...
                        boolean z7 = _filesystemkt_collectrecursively_1.Z$1;
                        boolean z8 = _filesystemkt_collectrecursively_1.Z$0;
                        ...
                        try {
                            ...
                            while (it.hasNext()) {
                                Path next = it.next();
                                _filesystemkt_collectrecursively_1.L$0 = sequenceScope2;
                                _filesystemkt_collectrecursively_1.L$1 = fileSystem3;
                                ...
                                _filesystemkt_collectrecursively_1.Z$0 = z8;
                                _filesystemkt_collectrecursively_1.Z$1 = z7;
                                _filesystemkt_collectrecursively_1.label = 2;
                                if (collectRecursively(sequenceScope2, fileSystem3, arrayDeque3, next, z8, z7, _filesystemkt_collectrecursively_1) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                            }
